...
public class UpdateSubActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fullIncome =  quntaties.getFullIncome();
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(inputFinancialDues.getText().toString())&&!TextUtils.isEmpty(inputExpenses.getText().toString())){
                    ...
                    if (inputFinancialDuesValue > financialDuesMax){
                        Toast.makeText(UpdateSubActivity.this, financialDuesHint, Toast.LENGTH_SHORT).show();
                        return;
                    }
                    if (inputExpensesValue > expenseMax){
                        Toast.makeText(UpdateSubActivity.this, expensesHint, Toast.LENGTH_SHORT).show();
                        return;
                    }
                    submitForm();
                }
    ...
    private void setMoneyQuantities(){
        ...
        startActivity(new Intent(UpdateSubActivity.this, EntranceActivity.class));
        finish();
    }
